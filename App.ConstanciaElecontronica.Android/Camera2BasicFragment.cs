...
using App.ConstanciaElecontronica.Droid.Listeners;
using Java.IO;
using Java.Lang;
using Java.Util;
...
{
    public class Camera2BasicFragment : Android.Support.V4.App.Fragment, View.IOnClickListener
    {
        ...
        public Task RetrieveCameraDevice()
        {
        ...
        {
            mTextureView = (AutoFitTextureView)view.FindViewById(Resource.Id.cameratexture);
        ...
        private void SetUpCameraOutputs(int width, int height)
        {
            ...
            try
            {
                for (var i = 1; i < manager.GetCameraIdList().Length; i++)
                {
        ...
        {
           // Toast.MakeText(this.Context, "guardando foto en... : "+mFile.AbsoluteFile, ToastLength.Short).Show();
            LockFocus();
        }
